...
function formatDate(date: Date, locale: string): string {
  ...
  return date.toLocaleDateString(locale === "es" ? "es-ES" : locale === "zh" ? "zh-CN" : locale === "ja" ? "ja-JP" : "en-GB", {
    day: "numeric",
    month: "long",
    year: "numeric",
  });
...
export default async function DashboardPage({
  ...
  try {
    ...
    const safeLocale = (locale === "en" ? "en" : locale === "zh" ? "zh" : locale === "ja" ? "ja" : "es") as Locale;
  ...
  // Tiene suscripción activa: is_pro O tiene org (pagó) y no está expirada
        ...
        <div className="grid gap-6 mb-8 md:grid-cols-3">
          ...
          <div className="bg-drawsports-bg-card rounded-2xl border border-white/5 shadow-drawsports-card p-6 min-h-[180px] flex flex-col">
            ...
            <div className="space-y-4">
              ...
              {hasActiveSubscription && !effectiveStart && !effectiveEnd && (
