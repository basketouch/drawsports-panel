...
export const LEMON_SQUEEZY_VARIANTS = [
  { checkoutId: "1e8a160e-d39e-424a-819c-bce00a7aee85", users: 1, price: "89,99€" },
  { checkoutId: "20b3dbf7-1e21-482c-8d0b-4faa63033097", users: 3, price: "285€" },
  { checkoutId: "13aa906b-7bfa-4c4a-ad15-f8802bd56691", users: 5, price: "450€" },
] as const;
